...
import CartWidget from '../../sections/@dashboard/product/CartWidget';
import { ProductDetailsSummary, ProductDetailsReview } from '../../sections/@dashboard/product/product-details';
// ----------------------------------------------------------------------
          ...
          <>
            ...
            <Card>
              <TabContext value={value}>
                ...
                <TabPanel value="2">
                  <ProductDetailsReview product={PRODUCT_DATA} />
                </TabPanel>
              </TabContext>
            </Card>
          </>
